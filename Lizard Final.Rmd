...
geom_smooth() +
labs(fill = "", x = "Shrub Density", y= "Use", color = "Mesohabitat") +
theme_classic() + scale_color_manual(values = c("above" = "red", "below" = "dark blue")) + labs(fill = "Mesohabitat") + theme(aspect.ratio = 1) +
xlim(0,200)
fig1
```
```{r}
fig3 <- ggplot (data, aes(x = shrub_density,y= shrub_cover)) +
  geom_point() +
  labs(fill = "", x = "Shrub Density", y= "Shrub Cover") + theme_classic() +  scale_color_manual(values = c("0" = "red", "1" = "dark blue")) + labs(fill = "Status") + theme(aspect.ratio = 1)  + xlim(0,60) + labs(color = "Mesohabitat")
fig3
